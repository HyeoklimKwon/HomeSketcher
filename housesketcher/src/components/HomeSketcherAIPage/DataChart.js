...
const DataChart = ({ responseData }) => {
  ...
  if (responseData) {
    data = [
      ...
      {
        country: 'Natural',
        zeroTo19: responseData[0]['Natural'],
        zeroTo19Color: 'hsl(72, 70%, 50%)',
        twenites: responseData[20]['Natural'],
        twenitesColor: 'hsl(53, 70%, 50%)',
        thirites: responseData[30]['Natural'],
        thiritesColor: 'hsl(231, 70%, 50%)',
        forties: responseData[40]['Natural'],
        fortiesColor: 'hsl(118, 70%, 50%)',
        fifties: responseData[50]['Natural'],
        fiftiesColor: 'hsl(164, 70%, 50%)',
        sixties: responseData[60]['Natural'],
        sixtiesColor: 'hsl(205, 70%, 50%)',
        seventies: responseData[70]['Natural'],
        seventiesColor: 'hsl(86, 70%, 50%)',
      ...
      {
        country: 'Minimal',
        zeroTo19: responseData[0]['Minimal'],
        zeroTo19Color: 'hsl(101, 70%, 50%)',
        twenites: responseData[20]['Minimal'],
        twenitesColor: 'hsl(208, 70%, 50%)',
        thirites: responseData[30]['Minimal'],
        thiritesColor: 'hsl(237, 70%, 50%)',
        forties: responseData[40]['Minimal'],
        fortiesColor: 'hsl(156, 70%, 50%)',
        fifties: responseData[50]['Minimal'],
        fiftiesColor: 'hsl(332, 70%, 50%)',
        sixties: responseData[60]['Minimal'],
        sixtiesColor: 'hsl(121, 70%, 50%)',
        seventies: responseData[70]['Minimal'],
        seventiesColor: 'hsl(86, 70%, 50%)',
      ...
      {
        country: 'North European',
        zeroTo19: responseData[0]['North European'],
        zeroTo19Color: 'hsl(340, 70%, 50%)',
        twenites: responseData[20]['North European'],
        twenitesColor: 'hsl(314, 70%, 50%)',
        thirites: responseData[30]['North European'],
        thiritesColor: 'hsl(31, 70%, 50%)',
        forties: responseData[40]['North European'],
        fortiesColor: 'hsl(275, 70%, 50%)',
        fifties: responseData[50]['North European'],
        fiftiesColor: 'hsl(19, 70%, 50%)',
        sixties: responseData[60]['North European'],
        sixtiesColor: 'hsl(50, 70%, 50%)',
        seventies: responseData[70]['North European'],
        seventiesColor: 'hsl(86, 70%, 50%)',
      ...
      {
        country: 'Vintage',
        zeroTo19: responseData[0]['Vintage'],
        zeroTo19Color: 'hsl(56, 70%, 50%)',
        twenites: responseData[20]['Vintage'],
        twenitesColor: 'hsl(357, 70%, 50%)',
        thirites: responseData[30]['Vintage'],
        thiritesColor: 'hsl(253, 70%, 50%)',
        forties: responseData[40]['Vintage'],
        fortiesColor: 'hsl(46, 70%, 50%)',
        fifties: responseData[50]['Vintage'],
        fiftiesColor: 'hsl(93, 70%, 50%)',
        sixties: responseData[60]['Vintage'],
        sixtiesColor: 'hsl(27, 70%, 50%)',
        seventies: responseData[70]['Vintage'],
        seventiesColor: 'hsl(86, 70%, 50%)',
      ...
      {
        country: 'Antique',
        zeroTo19: responseData[0]['Antique'],
        zeroTo19Color: 'hsl(265, 70%, 50%)',
        twenites: responseData[20]['Antique'],
        twenitesColor: 'hsl(287, 70%, 50%)',
        thirites: responseData[30]['Antique'],
        thiritesColor: 'hsl(135, 70%, 50%)',
        forties: responseData[40]['Antique'],
        fortiesColor: 'hsl(273, 70%, 50%)',
        fifties: responseData[50]['Antique'],
        fiftiesColor: 'hsl(257, 70%, 50%)',
        sixties: responseData[60]['Antique'],
        sixtiesColor: 'hsl(13, 70%, 50%)',
        seventies: responseData[70]['Antique'],
        seventiesColor: 'hsl(86, 70%, 50%)',
      ...
      {
        country: 'Provence',
        zeroTo19: responseData[0]['Provence'],
        zeroTo19Color: 'hsl(205, 70%, 50%)',
        twenites: responseData[20]['Provence'],
        twenitesColor: 'hsl(356, 70%, 50%)',
        thirites: responseData[30]['Provence'],
        thiritesColor: 'hsl(182, 70%, 50%)',
        forties: responseData[40]['Provence'],
        fortiesColor: 'hsl(15, 70%, 50%)',
        fifties: responseData[50]['Provence'],
        fiftiesColor: 'hsl(103, 70%, 50%)',
        sixties: responseData[60]['Provence'],
        sixtiesColor: 'hsl(183, 70%, 50%)',
        seventies: responseData[70]['Provence'],
        seventiesColor: 'hsl(86, 70%, 50%)',
      ...
      {
        country: 'Mediterranean',
        zeroTo19: responseData[0]['Mediterranean'],
        zeroTo19Color: 'hsl(205, 70%, 50%)',
        twenites: responseData[20]['Mediterranean'],
        twenitesColor: 'hsl(356, 70%, 50%)',
        thirites: responseData[30]['Mediterranean'],
        thiritesColor: 'hsl(182, 70%, 50%)',
        forties: responseData[40]['Mediterranean'],
        fortiesColor: 'hsl(15, 70%, 50%)',
        fifties: responseData[50]['Mediterranean'],
        fiftiesColor: 'hsl(103, 70%, 50%)',
        sixties: responseData[60]['Mediterranean'],
        sixtiesColor: 'hsl(183, 70%, 50%)',
        seventies: responseData[70]['Mediterranean'],
        seventiesColor: 'hsl(86, 70%, 50%)',
